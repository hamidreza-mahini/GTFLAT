...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", type=str, default="FashionMnist-alpha1.0-ratio1")
    parser.add_argument("--algorithms", type=str, default="FedAvg,GTFedAvg,FedProx,GTFedProx,FedGen,GTFedGen", help='algorithm names separate by comma')
    parser.add_argument("--result_path", type=str, default="FashionMnist-alpha1.0-ratio1", help="directory path to save results")
    parser.add_argument("--model", type=str, default="cnn")
    parser.add_argument("--learning_rate", type=float, default=0.01, help='learning rate.')
    parser.add_argument("--local_epochs", type=int, default=20)
    parser.add_argument("--num_glob_iters", type=int, default=201)
    ...
    parser.add_argument("--erir", type=int, default=0)
    parser.add_argument("--erir_round", type=int, default=200)
    parser.add_argument("--erir_epsilon", type=float, default= 0.0001)
