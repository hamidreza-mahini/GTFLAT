...
def get_data_dir(dataset):
    if 'EMnist' in dataset:
        ...
        types = 'letters'
        path_prefix = os.path.join('data', 'EMnist', f'u50-{types}-alpha{alpha}-ratio{ratio}')
        ...
        dataset_=dataset.replace('alpha', '').replace('ratio', '').split('-')
        alpha, ratio=dataset_[1], dataset_[2]
        #path_prefix=os.path.join('data', 'Mnist', 'u50alpha{}min10ratio{}'.format(alpha, ratio))
        path_prefix=os.path.join('data', 'FashionMnist', 'u50c10-alpha{}-ratio{}'.format(alpha, ratio))
        train_data_dir=os.path.join(path_prefix, 'train')
        test_data_dir=os.path.join(path_prefix, 'test')
        ...
        alpha, ratio=dataset_[1], dataset_[2]
        #path_prefix=os.path.join('data', 'Mnist', 'u50alpha{}min10ratio{}'.format(alpha, ratio))
        path_prefix=os.path.join('data', 'Mnist', 'u50c10-alpha{}-ratio{}'.format(alpha, ratio))
        train_data_dir=os.path.join(path_prefix, 'train')
        test_data_dir=os.path.join(path_prefix, 'test')
        ...
        alpha, ratio=dataset_[1], dataset_[2]
        #path_prefix=os.path.join('data', 'Mnist', 'u50alpha{}min10ratio{}'.format(alpha, ratio))
        path_prefix=os.path.join('data', 'Cifar10', 'u50c10-alpha{}-ratio{}'.format(alpha, ratio))
        train_data_dir=os.path.join(path_prefix, 'train')
        test_data_dir=os.path.join(path_prefix, 'test')
